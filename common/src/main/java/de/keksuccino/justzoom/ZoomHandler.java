...
public class ZoomHandler {
    ...
    public static void onCameraTick() {
        ...
        getZoomLevelState().tick(zooming, options.smoothZoomInOut.getValue(), options.smoothZoomScrollSpeedPercentage.getValue(), options.startZoomingAnimationSpeed.getValue(), options.stopZoomingAnimationSpeed.getValue(), getConfiguredMaximumMagnification(cachedNormalFov));
    }
